  ...
  <main class="container text-white">
    <div class="pt-4 mb-8 relative">
      ...
      <ul class="absolute bg-weather-secondary text-white w-full shadow-md py-2 px-1 top-[66px]" v-if="mapboxSearchResults">
        ...
        <p v-if="!searchError && mapboxSearchResults.length === 0">No results match your query. try diffent term.</p>
...
const mapboxAPIKey = "pk.eyJ1IjoibXBldGUtNTk5MyIsImEiOiJjbHN5Z2VjNHkwMnBrMm1ucnZkcWxkdm93In0.BYwYYlETL_qr7Tet-yiPSQ"
